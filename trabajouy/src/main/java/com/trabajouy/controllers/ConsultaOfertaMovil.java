...
@WebServlet("/consultaOfertaMovil")
public class ConsultaOfertaMovil extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConsultaOfertaMovil() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.getRequestDispatcher("/WEB-INF/movil/consultaOfertaMovil.jsp").include(request, response);
